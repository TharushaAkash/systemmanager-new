...
import Vehicles from "./staff/Vehicles";
import ServiceTypes from "./staff/ServiceTypes";
import UserManagement from "./staff/UserManagement";
import MyVehicles from "./customer/MyVehicles";
import JobManagement from "./technician/JobManagement";
import TechnicianDashboard from "./technician/TechnicianDashboard";
import Technicians from "./technician/Technicians";
import PendingJobs from "./technician/PendingJobs";
import CurrentJobs from "./technician/CurrentJobs";
import CustomerProfile from "./customer/CustomerProfile";
import ServicesShowcase from "./customer/ServicesShowcase";
import ServiceCenterBooking from "./customer/ServiceCenterBooking";
import CustomerMyBookings from "./customer/CustomerMyBookings";
import CustomerDashboard from "./customer/CustomerDashboard";
import PaymentGateway from "./customer/PaymentGateway";
            ...
            {isCustomer ? (
                ...
                <>
                    ...
                    <main style={{ flex: 1 }}>
                        ...
                        {page === "service-booking" && <section className="section"><div className="container"><ProtectedRoute requiredRole="CUSTOMER"><ServiceCenterBooking bookingType={navigationParams.bookingType || "SERVICE"} showTypeSelector={navigationParams.showTypeSelector !== false} selectedServiceType={navigationParams.selectedService} onNavigate={navigateTo} /></ProtectedRoute></div></section>}
